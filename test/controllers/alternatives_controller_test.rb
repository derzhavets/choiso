...
class AlternativesControllerTest < ActionController::TestCase
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post :create, alternative: { name: @alternative.name, proposed_by: @alternative.proposed_by, user_id: @alternative.user_id }
    end
  ...
  test "should update alternative" do
    patch :update, id: @alternative, alternative: { name: @alternative.name, proposed_by: @alternative.proposed_by, user_id: @alternative.user_id }
    assert_redirected_to alternative_path(assigns(:alternative))
  end
